...
abstract class CsvDecoder<out Item: CsvDecodable>(
    private val delimiter: String = ",",
    private val lineDelimiter: String = "\n",
    private val quote: Quote? = Quote.DOUBLE_QUOTE,
    private val numberOfHeaderLines: Int = 0
): Decoder<List<Item>, CsvDecoder.CsvDecoderError> {
    ...
    override fun decode(string: String): Result<List<Item>, CsvDecoderError> {
        val items = string
            .split("${quote?.char ?: ""}$lineDelimiter${quote?.char ?: ""}")
